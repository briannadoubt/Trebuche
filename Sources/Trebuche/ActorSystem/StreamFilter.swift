...
public struct StreamFilter: Codable, Sendable {
    ...
    public func matches(_ data: Data, previousData: Data? = nil) -> Bool {
        ...
        case .predefined:
            ...
            return matchesPredefined(filterName, data: data, previousData: previousData)
    ...
    private func matchesPredefined(_ filterName: String, data: Data, previousData: Data?) -> Bool {
        switch filterName {
    ...
    private func matchesNonEmpty(data: Data) -> Bool {
        do {
    ...
    private func matchesThreshold(data: Data) -> Bool {
